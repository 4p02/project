...
INSERT INTO private.payments (payment_dates, end_pro, user_id)
VALUES
  ('{"2024-03-15 10:00:00', '2024-03-16 10:00:00"}', '2024-03-16 10:00:00', 1),
  ('{"2024-03-14 10:00:00', '2024-03-15 10:00:00"}', '2024-03-15 10:00:00', 2),
  ('{"2024-03-13 10:00:00', '2024-03-14 10:00:00"}', '2024-03-14 10:00:00', 3);
...
VALUES
  ('2024-03-15 10:00:00', 'document', 'doc1.pdf', 'http://example.com/doc1.pdf', 'Document 1', pg_read_binary_file('../assets/001.jpg'), NULL, NULL),
  ('2024-03-15 10:00:00', 'document', 'doc2.pdf', 'http://example.com/doc2.pdf', 'Document 2', pg_read_binary_file('../assets/002.jpg'), NULL, NULL),
  ('2024-03-15 10:00:00', 'document', 'doc3.pdf', 'http://example.com/doc3.pdf', 'Document 3', pg_read_binary_file('../assets/001.jpg'), NULL, NULL);
