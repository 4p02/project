...
"""_summary_
 The database currently connects to the temporary database that is set up can create a user table and
 delete the user table
    Returns:
        _type_: _description_
"""
class Database:
    DB_URL = "postgresql://postgres:FDCaabG5bAgA3-D24B6eAGaEFFbE64b6@roundhouse.proxy.rlwy.net:20537/railway"
